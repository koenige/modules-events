 ...
 * @copyright Copyright © 2005-2026 Gustaf Mossakowski
...
$zz['fields'][4]['default'] = wrap_date_plain(date('Y-m-d', time()));
...
$zz['fields'][5]['validate_msg']['>='] = 'An event can only end after the start.';
