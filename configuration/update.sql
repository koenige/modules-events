...
/* 2023-08-12-1 */	UPDATE _settings SET setting_value = '/ics/%s' WHERE setting_key = 'events_ics_path' AND setting_value = '/ics';
/* 2023-08-15-1 */	CREATE TABLE `eventdetails` (`eventdetail_id` int unsigned NOT NULL AUTO_INCREMENT, `event_id` int unsigned NOT NULL, `identification` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL, `label` varchar(127) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL, `detail_category_id` int unsigned NOT NULL, `active` enum('yes','no') CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL DEFAULT 'yes', `last_update` timestamp NOT NULL, PRIMARY KEY (`eventdetail_id`), KEY `termin_id` (`event_id`), KEY `detail_category_id` (`detail_category_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/* 2023-08-15-2 */	INSERT INTO _relations (`master_db`, `master_table`, `master_field`, `detail_db`, `detail_table`, `detail_id_field`, `detail_field`, `delete`) VALUES ((SELECT DATABASE()), 'events', 'event_id', (SELECT DATABASE()), 'eventdetails', 'eventdetail_id', 'event_id', 'delete');
/* 2023-08-15-3 */	INSERT INTO _relations (`master_db`, `master_table`, `master_field`, `detail_db`, `detail_table`, `detail_id_field`, `detail_field`, `delete`) VALUES ((SELECT DATABASE()), 'categories', 'category_id', (SELECT DATABASE()), 'eventdetails', 'eventdetail_id', 'detail_category_id', 'no-delete');
/* 2023-08-15-4 */	INSERT INTO categories (`category`, `category_short`, `description`, `main_category_id`, `path`, `parameters`, `sequence`, `last_update`) VALUES ("Event Details", NULL, NULL, NULL, "event-details", "&alias=event-details", NULL, NOW());
/* 2023-08-15-5 */	INSERT INTO categories (`category`, `category_short`, `description`, `main_category_id`, `path`, `parameters`, `sequence`, `last_update`) VALUES ("Event", NULL, NULL, (SELECT category_id FROM categories c WHERE c.path = "event-details"), "event-details/event", "&alias=event-details/event&direct_link=1", NULL, NOW());
/* 2023-08-15-6 */	INSERT INTO categories (`category`, `category_short`, `description`, `main_category_id`, `path`, `parameters`, `sequence`, `last_update`) VALUES ("Announcement", NULL, NULL, (SELECT category_id FROM categories c WHERE c.path = "event-details"), "event-details/announcement", "&alias=event-details/announcement", NULL, NOW());
/* 2023-08-15-7 */	INSERT INTO categories (`category`, `category_short`, `description`, `main_category_id`, `path`, `parameters`, `sequence`, `last_update`) VALUES ("Organiser", NULL, NULL, (SELECT category_id FROM categories c WHERE c.path = "event-details"), "event-details/organiser", "&alias=event-details/organiser", NULL, NOW());
/* 2023-08-15-8 */	INSERT INTO categories (`category`, `category_short`, `description`, `main_category_id`, `path`, `parameters`, `sequence`, `last_update`) VALUES ("Report", NULL, NULL, (SELECT category_id FROM categories c WHERE c.path = "event-details"), "event-details/report", "&alias=event-details/report", NULL, NOW());
/* 2023-08-15-9 */	INSERT INTO categories (`category`, `category_short`, `description`, `main_category_id`, `path`, `parameters`, `sequence`, `last_update`) VALUES ("Results", NULL, NULL, (SELECT category_id FROM categories c WHERE c.path = "event-details"), "event-details/results", "&alias=event-details/results", NULL, NOW());
...
/* 2026-07-31-2 */	UPDATE categories SET parameters = REPLACE(parameters, '&events_accomodation=1', '&events_accommodation=1') WHERE parameters LIKE '%&events_accomodation=1%';
